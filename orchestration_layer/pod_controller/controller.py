...
from k8s_utils.kube_init import batch_v1
from k8s_utils.pod_info import get_node_name
...
def build_env_vars(pod_name, pod_namespace, container_name, id):
    return [
        ...
        client.V1EnvVar(name="ID", value=id),
...
def create_sidecar_controller(pod_name, pod_namespace, container_name):
    ...
    )  # The sidecar controller needs to be deployed in the same node as the pod, in order to access kubelet checkpoint information.
